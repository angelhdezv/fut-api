...
var Players = /** @class */ (function () {
    ...
    Players.prototype.getDetails = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, this.sql.getPlayersDetails(id)];
                    case 1:
                        result = _a.sent();
    ...
    Players.prototype.getList = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sql.getPlayersList()];
                    case 1:
                        result = _a.sent();
    ...
    Players.prototype.save = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var player;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        player = new Player_1["default"](req.params.id)
                            .build(req.params.name, req.params.team);
                        return [4 /*yield*/, this.sql.savePlayer(player)];
                    case 1:
                        player = _a.sent();
                        return [2 /*return*/, util_1["default"].sendModel(res, player)];
                }
            });
        });
    };
